...

{
  ...
  assert(td.data.room.party.phase === 'idle', 'truthDare idle before seats')
  ...
  assert(host.room.party.phase === 'drawing', 'claim → drawing')
  assert(host.room.party.drawerSeatId === td.session.seatId, 'host is drawer')
